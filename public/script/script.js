...
const minimaxAiLogic = ((percentage) => {
    ...
    const minimax = (newBoard, player) => {
        ...
        for (let i = 0; i < empty.length; i++) {
            ...
            //Mereset nilai yang tadina sudah ditentukan
...
const gameController = (() => {
    ...
    /**
     * Mengecek apabila permainan menjadi seri
     * Jika seri, akan mengembalikan 'true', Jika tidak maka akan 'false' 
     */
    ...
    /**
     * Langkah pemain ke bidang, dan memeriksa apakah permainan telah berakhir
     * Jika permainan selesai, maka button akan dinonaktifkan.
     * @param {int} num - Index bidang yang dipencet pemain
     */
    ...
    const endGame = function(sign){
        ...
        const winElements = document.querySelectorAll('.win-condition p')
